  ...
  paths = {
    {
      ...
      expert = {
        {
          title = "ASM code",
          txt = "In the binary file, the address of the loop is: 414093\n\nInstruction                                                                             | Nb FU | P0   | P1   | P2 | P3 | P4 | P5   | Latency | Recip. throughput\n-----------------------------------------------------------------------------------------------------------------------------------------------------------------\nMOV %RAX,%R11                                                                           | 1     | 0.33 | 0.33 | 0  | 0  | 0  | 0.33 | 1       | 0.33\nMOV %R11,0x8(%RSP)                                                                      | 1     | 0    | 0    | 0  | 1  | 1  | 0    | 3       | 1\nMOV %R11,%RAX                                                                           | 1     | 0.33 | 0.33 | 0  | 0  | 0  | 0.33 | 1       | 0.33\nMOVSD 0x8(%RSP),%XMM0                                                                   | 1     | 0    | 0    | 1  | 0  | 0  | 0    | 2       | 1\nADDSD %XMM7,%XMM0                                                                       | 1     | 0    | 1    | 0  | 0  | 0  | 0    | 3       | 1\nMOVQ %XMM0,%R8                                                                          | 1     | 0.33 | 0.33 | 0  | 0  | 0  | 0.33 | 1       | 0.33\nLOCK CMPXCHG %R8,(%R10)\nCMP %RAX,%R11                                                                           | 1     | 0.33 | 0.33 | 0  | 0  | 0  | 0.33 | 1       | 0.33\nJNE 414090 <_ZN7ForceLJ26compute_halfneigh_threadedILi1ELi1EEEvR4AtomR8Neighbori+0x5a0> | 1     | 0    | 0    | 0  | 0  | 0  | 1    | 0       | 2\n",
        },
        {

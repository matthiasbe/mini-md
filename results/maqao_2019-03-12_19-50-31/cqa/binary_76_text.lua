  ...
  paths = {
    {
      ...
      expert = {
        {
          title = "ASM code",
          txt = "In the binary file, the address of the loop is: 416663\n\nInstruction                                                                             | Nb FU | P0   | P1   | P2 | P3 | P4 | P5   | Latency | Recip. throughput\n-----------------------------------------------------------------------------------------------------------------------------------------------------------------\nMOV %RAX,%R8                                                                            | 1     | 0.33 | 0.33 | 0  | 0  | 0  | 0.33 | 1       | 0.33\nMOV %R8,0x8(%RSP)                                                                       | 1     | 0    | 0    | 0  | 1  | 1  | 0    | 3       | 1\nMOV %R8,%RAX                                                                            | 1     | 0.33 | 0.33 | 0  | 0  | 0  | 0.33 | 1       | 0.33\nMOVSD 0x8(%RSP),%XMM2                                                                   | 1     | 0    | 0    | 1  | 0  | 0  | 0    | 2       | 1\nADDSD %XMM5,%XMM2                                                                       | 1     | 0    | 1    | 0  | 0  | 0  | 0    | 3       | 1\nMOVQ %XMM2,%R13                                                                         | 1     | 0.33 | 0.33 | 0  | 0  | 0  | 0.33 | 1       | 0.33\nLOCK CMPXCHG %R13,(%RCX)\nCMP %RAX,%R8                                                                            | 1     | 0.33 | 0.33 | 0  | 0  | 0  | 0.33 | 1       | 0.33\nJNE 416660 <_ZN7ForceLJ26compute_halfneigh_threadedILi0ELi1EEEvR4AtomR8Neighbori+0x590> | 1     | 0    | 0    | 0  | 0  | 0  | 1    | 0       | 2\n",
        },
        {

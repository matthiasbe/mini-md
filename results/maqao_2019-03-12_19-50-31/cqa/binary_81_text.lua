  ...
  paths = {
    {
      ...
      expert = {
        {
          title = "ASM code",
          txt = "In the binary file, the address of the loop is: 4165c3\n\nInstruction                                                                             | Nb FU | P0   | P1   | P2 | P3 | P4 | P5   | Latency | Recip. throughput\n-----------------------------------------------------------------------------------------------------------------------------------------------------------------\nMOV %RAX,%RCX                                                                           | 1     | 0.33 | 0.33 | 0  | 0  | 0  | 0.33 | 1       | 0.33\nMOV %RCX,0x8(%RSP)                                                                      | 1     | 0    | 0    | 0  | 1  | 1  | 0    | 3       | 1\nMOV %RCX,%RAX                                                                           | 1     | 0.33 | 0.33 | 0  | 0  | 0  | 0.33 | 1       | 0.33\nMOVSD 0x8(%RSP),%XMM3                                                                   | 1     | 0    | 0    | 1  | 0  | 0  | 0    | 2       | 1\nSUBSD %XMM0,%XMM3                                                                       | 1     | 0    | 1    | 0  | 0  | 0  | 0    | 3       | 1\nMOVQ %XMM3,%R8                                                                          | 1     | 0.33 | 0.33 | 0  | 0  | 0  | 0.33 | 1       | 0.33\nLOCK CMPXCHG %R8,(%RSI)\nCMP %RAX,%RCX                                                                           | 1     | 0.33 | 0.33 | 0  | 0  | 0  | 0.33 | 1       | 0.33\nJNE 4165c0 <_ZN7ForceLJ26compute_halfneigh_threadedILi0ELi1EEEvR4AtomR8Neighbori+0x4f0> | 1     | 0    | 0    | 0  | 0  | 0  | 1    | 0       | 2\n",
        },
        {

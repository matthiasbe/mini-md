  ...
  paths = {
    {
      ...
      expert = {
        {
          title = "ASM code",
          txt = "In the binary file, the address of the loop is: 416633\n\nInstruction                                                                             | Nb FU | P0   | P1   | P2 | P3 | P4 | P5   | Latency | Recip. throughput\n-----------------------------------------------------------------------------------------------------------------------------------------------------------------\nMOV %RAX,%R10                                                                           | 1     | 0.33 | 0.33 | 0  | 0  | 0  | 0.33 | 1       | 0.33\nMOV %R10,0x8(%RSP)                                                                      | 1     | 0    | 0    | 0  | 1  | 1  | 0    | 3       | 1\nMOV %R10,%RAX                                                                           | 1     | 0.33 | 0.33 | 0  | 0  | 0  | 0.33 | 1       | 0.33\nMOVSD 0x8(%RSP),%XMM15                                                                  | 1     | 0    | 0    | 1  | 0  | 0  | 0    | 2       | 1\nADDSD %XMM6,%XMM15                                                                      | 1     | 0    | 1    | 0  | 0  | 0  | 0    | 3       | 1\nMOVQ %XMM15,%RSI                                                                        | 1     | 0.33 | 0.33 | 0  | 0  | 0  | 0.33 | 1       | 0.33\nLOCK CMPXCHG %RSI,(%R9)\nCMP %RAX,%R10                                                                           | 1     | 0.33 | 0.33 | 0  | 0  | 0  | 0.33 | 1       | 0.33\nJNE 416630 <_ZN7ForceLJ26compute_halfneigh_threadedILi0ELi1EEEvR4AtomR8Neighbori+0x560> | 1     | 0    | 0    | 0  | 0  | 0  | 1    | 0       | 2\n",
        },
        {

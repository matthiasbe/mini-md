...
-- Name of the binary file to analyze
binary = "/home/matthias/cours/minimd/project/bin/miniMD_openmpi"
...
-- Use an empty string or remove the declaration if no 
-- specific command is required to run the application
run_command = "<binary> -i /home/matthias/cours/minimd/project/config/in.lj.custom -t 4"
